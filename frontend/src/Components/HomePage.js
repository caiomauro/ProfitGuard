...
const HomePage = () => {
  ...
  return (
    <div>
      ...
      >
        <div className="grid grid-cols-3 bg-gray-500 mb-4 h-20">
          <div></div>
        ...
        <div className="w-full mx-auto p-4 mb-4 bg-gray-500">
          <div className="flex flex-col items-center py-5 px-4 justify-center mb-5">
            <h1 className="font-semibold text-white text-2xl px-3 py-1 rounded-t-md text-center">
              {" "}
              What is ProfitGuard?{" "}
            </h1>
            <div className="w-2/3 p-3 custom-background-img rounded-md shadow-lg">
              <p className="font-extralight text-white bg-gray-500 p-4 rounded-md text-lg text-left">
          ...
          <div id="img-container" className="flex flex-row items-center justify-between p-4 rounded-md shadow-lg">
